                            ...
                            <table class="am-table am-table-bd am-table-bdrs am-table-striped am-table-hover">
                                ...
                                <tr>
                                    <td class="am-text-center"><img
                                            src="<%=request.getContextPath()%>/assets/AmazeUI-2.7.2/assets/i/examples/admin-chrome.png"
                                            alt="">
                                    </td>
                                    <td>Google Chrome</td>
                                    <td>3,005</td>
                                ...
                                <tr>
                                    <td class="am-text-center"><img
                                            src="<%=request.getContextPath()%>/assets/AmazeUI-2.7.2/assets/i/examples/admin-firefox.png"
                                            alt="">
                                    </td>
                                ...
                                <tr>
                                    <td class="am-text-center"><img
                                            src="<%=request.getContextPath()%>/assets/AmazeUI-2.7.2/assets/i/examples/admin-ie.png"
                                            alt=""></td>
                                ...
                                <tr>
                                    <td class="am-text-center"><img
                                            src="<%=request.getContextPath()%>/assets/AmazeUI-2.7.2/assets/i/examples/admin-opera.png"
                                            alt=""></td>
                                    <td>Opera</td>
                                    <td>4,005</td>
                                </tr>
                                <tr>
                                    <td class="am-text-center"><img
                                            src="<%=request.getContextPath()%>/assets/AmazeUI-2.7.2/assets/i/examples/admin-safari.png"
                                            alt="">
                                    </td>
                                    <td>Safari</td>
                                    <td>505</td>
